...
<template>
  <PageContainer size="wide">
    ...
    <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      <NuxtLink
        to="/minutes"
        class="group flex min-h-[196px] flex-col rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md"
      >
        <div
        ...
        <div class="mt-auto space-y-2">
          <h2 class="text-xl font-semibold tracking-tight text-slate-900">議事録</h2>
          <p class="text-sm leading-6 text-slate-500">過去回の内容を時系列で確認できます。</p>
        </div>
      </NuxtLink>
      <NuxtLink
        to="/schedule"
      ...
      >
        ...
        <div class="mt-auto space-y-2">
          <h2 class="text-xl font-semibold tracking-tight text-slate-900">スケジュール</h2>
          <p class="text-sm leading-6 text-slate-500">今後の開催予定と参加リンクをまとめています。</p>
        </div>
      </NuxtLink>
      <NuxtLink
        to="/survey"
      ...
      >
        ...
        <div class="mt-auto space-y-2">
          <h2 class="text-xl font-semibold tracking-tight text-slate-900">アンケート</h2>
      ...
      >
        ...
        <div class="mt-auto space-y-2">
          <h2 class="text-xl font-semibold tracking-tight text-slate-900">資料共有</h2>
          <p class="text-sm leading-6 text-slate-500">発表資料と参考リンクを整理して掲載します。</p>
        </div>
      </NuxtLink>
    </section>
