...
export const FEEDS = [
  ...
  { name: "ITmedia NEWS", url: "https://rss.itmedia.co.jp/rss/2.0/news_bursts.xml", aiOnly: false },
  ...
  { name: "MIT Tech Review Japan", url: "https://www.technologyreview.jp/feed/", aiOnly: false },
  ...
  { name: "GitHub Blog (AI/ML)", url: "https://github.blog/ai-and-ml/feed/", aiOnly: true },
